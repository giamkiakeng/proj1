...
differential equation $\mathrm dX_t=AX_t\,\mathrm dt+B\,\mathrm dW_t$ whenever
$\frac12(AC^2+C^2A^\tp)\le BB^\tp$, and asked whether this condition is also necessary. We show that it is not,
