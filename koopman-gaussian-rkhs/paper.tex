...
\hyphenation{Aron-szajn Orn-stein Uhlen-beck Mat-ern}
...
stochastic dynamical system by
\[
...
of error bounds for kernel-based approximations of Koopman operators \cite{Koehne,Kostic,PhilippACHA} benefits greatly
...
\]
This identity also follows directly from \cite[Proposition~4.1]{PSWPN} and Lemma~\ref{lem:bumps}, because
