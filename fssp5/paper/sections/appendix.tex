...
# Proposition 6.3
./fsspcheck ../results/delta13_chaotic.txt 2 13   # OK
./germext 5 10000 3 24 800 < ../results/germs/germ_delta13c.txt
...
python3 germcert.py <the 230 refuted germs> 10 k14_n10   # UNSAT, VERIFIED
./germext 5 3300 3 12 < germs_K14_surv10.txt      # 14 x REFUTED (s=1)
\end{verbatim}}
The files \texttt{results/germs/germ\_delta12.txt} and
\texttt{germ\_delta13c.txt} contain the two germs in the one-line format of
